...
<body>
     <div id="tabla">
          <table border="1" class="table table-bordered table-dark">
               ...
               <tbody>
                    <?php include("modules/modul_menu/data.php"); ?>
                    <?php foreach($res as $fila) { ?>
                    <tr id="<?php echo $fila['nombre_plato']; ?>" onclick="Formulario('<?php echo $fila['nombre_plato']; ?>')" class="table-light">
                         <td><?php echo $fila["nombre_plato"]; ?></td>
     ...
     <div id="crud">
          <form  method="POST" id="">
               ...
               <input type="submit" value="Registrar" name="registrar" formaction="modules/modul_menu/register.php"> 
               <input type="submit" value="Eliminar" name="eliminar" formaction="modules/modul_menu/delete.php">
               <input type="submit" value="Modificar" name="modificar" formaction="modules/modul_menu/modify.php">
          </form>
     </div>
     ...
     <div id="lista">
          <select name="registros" id="" onchange="location = this.value">
               ...
               <option value="menu.php" selected>Menu</option>
